...
local function overridden_modules(modules)
  ...
  table.insert(
    ...
    (function()
      ...
      local errors = (errors_nr and errors_nr > 0)
          and ('%#St_lspError#󰅚 ' .. errors_nr .. ' ')
        or ''
      local warnings = (warnings_nr and warnings_nr > 0)
          and ('%#St_lspWarning# ' .. warnings_nr .. ' ')
        or ''
      local hints = (hints_nr and hints_nr > 0) and ('%#St_lspHints#󰛩 ' .. hints_nr .. ' ')
        or ''
