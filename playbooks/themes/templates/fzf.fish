...
if status is-interactive
    ...
    setenv FZF_CTRL_T_OPTS "--preview 'fzf-script-preview {}'"
    setenv FZF_ALT_C_OPTS "--preview 'fzf-script-preview {}'"
    ...
    setenv FZF_COMPLETION_OPTS "--preview 'fzf-script-preview {}'"
